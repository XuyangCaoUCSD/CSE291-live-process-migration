...
This software is hosted by: <http://sourceforge.net>
    ...
    *JPTCH* can then be used to reconstruct the second file from the
    first file.
    For example:
      o *jdiff* archive0000.tar archive0001.tar archive0001.jdf // on dumper
      o *jptch* archive0000.tar archive0001.jdf archive0001b.tar // on dumpee
    ...
    *JDIFF* tries to find a minimal set of differences between two files
    ...
    The current version of this utility is b�ta 0.8 dating from
